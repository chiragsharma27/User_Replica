...
const UserCard = ({ user, onUpdate, onRemove }) => {
  ...
  return (
    <div className="col-lg-3 col-md-6 mb-4 d-flex justify-content-center">
      <div className="card pt-0" style={{ width: '430px', height: '500px' }}>
      
        <div 
            className='container-fluid p-0 m-0 d-flex justify-content-center align-items-center' 
            style={{ background: '#f1f1f1', height: '100vh'}}  // Use 100vh to take full viewport height
            >
            <img
        ...
        <div className="card-body pt-3 mt-3">
          <h5 className="card-title pb-2 ps-3">{user.name}</h5>
          <p className="card-text pt-0 ps-3 lh-sm" style={{color: '#000000A6', fontSize: '17px'}}>
          <svg
          ...
          <p className="card-text lh-sm ps-3" style={{color: '#000000A6', fontSize: '17px'}}>
          <svg
          ...
          <p className="card-text mb-2 pt-0 lh-base ps-3" style={{color: '#000000A6', fontSize: '17px'}}>
            <svg 
                viewBox="64 64 896 896" 
                width="1em" 
                height="1em" 
        ...
        <div className="pt-1 pb-0 mt-1 mb-1 d-flex justify-content-between" style={{background: '#f1f1f1'}}>
          <button
                className="btn ms-5 mt-1 mb-1"
                onClick={toggleLike}
